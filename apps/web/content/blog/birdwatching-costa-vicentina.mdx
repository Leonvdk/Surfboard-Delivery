...
We rent **soft-top surfboards and wetsuits** with **free delivery** to **Aljezur, Arrifana, Vale da Telha, Monte Clérigo, Amoreira, Rogil, and Carrapateira** (broader Costa Vicentina — ask case-by-case) — [pricing here](/pricing) — so you can mix scopes and sessions without a shop run every day.

## Frequently asked questions

### When is the best time of year for birdwatching on the Costa Vicentina?

Spring and autumn migration — roughly March to May, and September to November. Those windows bring the widest variety, with passerines moving through the scrub and raptors on good days. Winter is quieter for migration but strong for waders and residents, and the light between fronts is excellent. Summer is the thinnest season for passage birds and the midday heat haze makes optics hard work.

### Do I need a guide to go birdwatching here?

Not for general trail birding — the coastal paths and estuary margins reward anyone with binoculars and patience. A local guide earns their fee if you want species-level identification, or you are targeting sensitive birds where wandering off on your own does harm. Ask any operator about group size, whether optics are provided, and how they handle park rules.
