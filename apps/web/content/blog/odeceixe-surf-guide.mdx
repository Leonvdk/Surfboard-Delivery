...
### What is the best tide at Odeceixe?

Mid tide is usually the most predictable window. There is enough water over the inside bar and less extreme drain-out from the river than at low. Low tide exposes shallow sections and concentrates the current where the river meets the sea; high tide can spread the energy across several weak sections. Because the river keeps moving sand, no tide rule holds all year.

### Can you surf Odeceixe in winter?

Yes, but it turns serious. Big northwest swell gets through, and the currents and closeouts increase with it — being sand rather than reef does not make it easier than Arrifana. Winter days here need solid fitness and honest judgement, and the shelter that Arrifana's cliffs offer is not there. On smaller winter days with an east wind it can be excellent and empty.

### How far is Odeceixe from Aljezur?

Roughly **20 minutes by car** north, depending on where you start in the parish. It is at the **northern edge of the Costa Vicentina** (the park runs from Odeceixe south toward Burgau). From an Aljezur base it works as a morning mission or a day trip, not as your default doorstep spot.
...
We do **not** operate on the sand at Odeceixe. If you are staying in our **delivery area**, we can bring gear to your accommodation; we do **not** offer bodyboards or SUPs. Rogil, on the road between Aljezur and Odeceixe, is inside the free delivery zone.
...
We deliver **soft-top boards** (6'6 to 8'6) and **wetsuits** (season-appropriate thickness) to accommodation in **Aljezur, Arrifana, Vale da Telha, Monte Clérigo, Amoreira, Rogil, and Carrapateira** — [see pricing](/pricing) or [message us](/contact) (WhatsApp or email; no online checkout).
