...
<InlineGearCta
	kicker="Portugal it is?"
	headline="Leave the board bag at home. Yours is waiting in Aljezur."
	cta="Check availability"
	href="/contact?package=full"
	note="Free delivery in Aljezur · Payment on arrival · Free cancellation up to 72h after booking"
	location="blog_portugal_vs_france_mid"
/>
...
- For gear in Aljezur without hauling boards on a plane, see [pricing](/pricing) or [contact](/contact) us — we deliver **soft-tops** and suits with **free delivery** to **Aljezur, Arrifana, Vale da Telha, Monte Clérigo, Amoreira, Rogil, and Carrapateira** (broader Costa Vicentina — ask case-by-case).
